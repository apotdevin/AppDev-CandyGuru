...
- (void)viewDidLoad
{
    ...
    [instruments addObject:@{@"Name": @"Crushing Speed 2" , @"Info" : @"Crush pills faster!" , @"Price": @"10000000" , @"Unlocks":@"1"}];
...
- (void)animateMoneyChange:(int)cuanto
{
    ...
    animationMoneyLabel.font = [UIFont fontWithName:@"28 Days Later" size:20];
