...
-(void)setupView
{
    ...
    completeDominance.font = [UIFont fontWithName:@"28 Days Later" size:18*textSize];
    ...
    zone1Label.font = [UIFont fontWithName:@"28 Days Later" size:14*placesSize];
    ...
    zone2Label.font = [UIFont fontWithName:@"28 Days Later" size:14*placesSize];
    ...
    zone3Label.font = [UIFont fontWithName:@"28 Days Later" size:14*placesSize];
    ...
    zone4Label.font = [UIFont fontWithName:@"28 Days Later" size:14*placesSize];
    ...
    zone5Label.font = [UIFont fontWithName:@"28 Days Later" size:14*placesSize];
    ...
    zone6Label.font = [UIFont fontWithName:@"28 Days Later" size:14*placesSize];
    ...
    zone7Label.font = [UIFont fontWithName:@"28 Days Later" size:14*placesSize];
    ...
    zone8Label.font = [UIFont fontWithName:@"28 Days Later" size:14*placesSize];
    ...
    zone9Label.font = [UIFont fontWithName:@"28 Days Later" size:14*placesSize];
    ...
    zone10Label.font = [UIFont fontWithName:@"28 Days Later" size:14*placesSize];
    ...
    for (int j=0; j<4; j++) {
        for (int i=-1; i<10; i++) {
            ...
            zoneInfo.font = [UIFont fontWithName:@"28 Days Later" size:14*placesSize];
