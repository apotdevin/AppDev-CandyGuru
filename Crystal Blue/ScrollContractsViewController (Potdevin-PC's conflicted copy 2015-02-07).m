...
-(void)startTables
{
    ...
    //Sellers
    [people addObject:@{@"Name": @"Sophia's Cart" , @"Info" : @"Sells 100 Candys" , @"Time" : @"4" , @"Need" : @"100" , @"Give" : @"100"}];
    [people addObject:@{@"Name": @"Jack's Cart" , @"Info" : @"Sells 150 Candys" , @"Time" : @"5" , @"Need" : @"150" , @"Give" : @"150"}];
    [people addObject:@{@"Name": @"Lukas's Cart" , @"Info" : @"Sells 200 Candys" , @"Time" : @"5" , @"Need" : @"200" , @"Give" : @"200"}];
    [people addObject:@{@"Name": @"Lily's Cart" , @"Info" : @"Sells 250 Candys" , @"Time" : @"5" , @"Need" : @"250" , @"Give" : @"250"}];
    [people addObject:@{@"Name": @"Noah's Cart" , @"Info" : @"Sells 300 Candys" , @"Time" : @"6" , @"Need" : @"300" , @"Give" : @"300"}];
    [people addObject:@{@"Name": @"Chloe's Cart" , @"Info" : @"Sells 350 Candys" , @"Time" : @"6" , @"Need" : @"350" , @"Give" : @"350"}];
    [people addObject:@{@"Name": @"Julia's Cart" , @"Info" : @"Sells 400 Candys" , @"Time" : @"6" , @"Need" : @"400" , @"Give" : @"400"}];
    [people addObject:@{@"Name": @"Pedro's Cart" , @"Info" : @"Sells 450 Candys" , @"Time" : @"7" , @"Need" : @"450" , @"Give" : @"450"}];
    [people addObject:@{@"Name": @"Dan's Cart" , @"Info" : @"Sells 500 Candys" , @"Time" : @"7" , @"Need" : @"500" , @"Give" : @"500"}];
    [people addObject:@{@"Name": @"Ana's Cart" , @"Info" : @"Sells 550 Candys" , @"Time" : @"7" , @"Need" : @"550" , @"Give" : @"550"}];
    //Bullys
    [people addObject:@{@"Name": @"Bumper Stickers" , @"Info" : @"800 for 50Xp" , @"Time" : @"4" , @"Need" : @"800" , @"Give" : @"50"}];
    [people addObject:@{@"Name": @"T-Shirts" , @"Info" : @"900 for 55Xp" , @"Time" : @"5" , @"Need" : @"900" , @"Give" : @"55"}];
    [people addObject:@{@"Name": @"Flyers" , @"Info" : @"1000 for 60Xp" , @"Time" : @"5" , @"Need" : @"1000" , @"Give" : @"60"}];
    [people addObject:@{@"Name": @"Magazines" , @"Info" : @"1100 for 65Xp" , @"Time" : @"5" , @"Need" : @"1100" , @"Give" : @"65"}];
    [people addObject:@{@"Name": @"Street Banners" , @"Info" : @"1200 for 70Xp" , @"Time" : @"6" , @"Need" : @"1200" , @"Give" : @"70"}];
    [people addObject:@{@"Name": @"Highway Banners" , @"Info" : @"1300 for 75Xp" , @"Time" : @"6" , @"Need" : @"1300" , @"Give" : @"75"}];
    [people addObject:@{@"Name": @"Newspaper" , @"Info" : @"1400 for 80Xp" , @"Time" : @"6" , @"Need" : @"1400" , @"Give" : @"80"}];
    [people addObject:@{@"Name": @"Internet" , @"Info" : @"1500 for 85Xp" , @"Time" : @"7" , @"Need" : @"1500" , @"Give" : @"85"}];
    [people addObject:@{@"Name": @"Radio Station" , @"Info" : @"1600 for 90Xp" , @"Time" : @"7" , @"Need" : @"1600" , @"Give" : @"90"}];
    [people addObject:@{@"Name": @"TV Ad" , @"Info" : @"1700 for 95Xp" , @"Time" : @"7" , @"Need" : @"1700" , @"Give" : @"95"}];
    ...
    for (int i = 0; i<20; i++) {
        ...
        locked.font = [UIFont fontWithName:@"28 Days Later" size:28];
        locked.text = @"LOCKED!";
        locked.frame = CGRectMake(0, 0, 160, 90);
        locked.textAlignment = NSTextAlignmentCenter;
        locked.backgroundColor = [UIColor colorWithRed:0.65 green:0.65 blue:0.62 alpha:0.96];
...
-(void)startInterface
{
    ...
    sellers.font = [UIFont fontWithName:@"28 Days Later" size:30];
    bullys.font = [UIFont fontWithName:@"28 Days Later" size:30];
    ...
    money.font = [UIFont fontWithName:@"28 Days Later" size:16];
    crystal.font = [UIFont fontWithName:@"28 Days Later" size:16];
    ...
    for (int i=0; i<20; i++) {
        ...
        nameLabel.font = [UIFont fontWithName:@"28 Days Later" size:16];
        ...
        infoLabel.font = [UIFont fontWithName:@"28 Days Later" size:12];
        ...
        locationButton.titleLabel.font = [UIFont fontWithName:@"28 Days Later" size:16];
        ...
        timerLabel.font = [UIFont fontWithName:@"28 Days Later" size:12];
        ...
        startButton.titleLabel.font = [UIFont fontWithName:@"28 Days Later" size:16];
        ...
        collectButton.titleLabel.font = [UIFont fontWithName:@"28 Days Later" size:16];
        ...
        if ([GameSaveState sharedGameData].currentSeller<=i&&column==0) {
            ...
            lockedLabel.center = CGPointMake(80+(160*column), 50+(padding*i)-((padding*(people.count/2))*column));
...
-(void)buttonPressedCollect:(UIButton *)sender
{
    ...
    else
    {
        ...
        else
        {
            ...
            float precioRandom = arc4random_uniform((int)sender.tag)+purityDecimales+6;
    ...
    tiempo.font = [UIFont fontWithName:@"28 Days Later" size:12];
...
-(void)buttonPressedStart:(UIButton *)sender
{
    if (![[[ClientsAtHome sharedClientData].placeSentTo objectAtIndex:sender.tag] isEqualToString:@"NONE"])
    {
        ...
        if (sender.tag>9) {
            ...
            else
            {
                ...
                money.font = [UIFont fontWithName:@"28 Days Later" size:18];
        ...
        else
        {
            ...
            {
                [[SoundHelper sharedSoundInstance] playSound:9];
                crystal.font = [UIFont fontWithName:@"28 Days Later" size:18];
    ...
    else
    {
        [[SoundHelper sharedSoundInstance] playSound:9];
        UIButton *sitioBoton = locationButtonArray[sender.tag];
        sitioBoton.titleLabel.font = [UIFont fontWithName:@"28 Days Later" size:16];
...
-(void)startTimer
{
    for (int i=0; i<20; i++) {
        if ([[ClientsAtHome sharedClientData].peopleOnOrOff[i] isEqualToString:@"EMPEZO"])
        {
            ...
            tiempo.font = [UIFont fontWithName:@"28 Days Later" size:20];
