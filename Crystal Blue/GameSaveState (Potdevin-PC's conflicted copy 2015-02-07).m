...
- (void)newGame
{
    ...
    _potActive = 0;
    _potDate = [NSDate date];
    _pastDate = [NSDate date];
...
- (void)loadGame
{
    ...
    else
    {
        ...
        _potDate = gameSaveArray[31];
        _pastDate = gameSaveArray[32];
    }
...
-(void)checkLevel
{
    ...
    {
        amountXpForLevel = 55000+(5000+1000*(_level-21))*(_level-21);
    }
